...
const ReportsDashboardPage = ({ onEnterSubmission }) => {
  ...
  const ICONS = {
      Overdue: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-theme-error-text" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
      IssuesFound: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-theme-warning-text" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>,
      UnderReview: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-theme-info-text" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
  };
