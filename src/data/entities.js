...
const entities = [
  {
    ...
    legalName: "Zenith Bank",
    registrationNumber: "ACORP-FIN-00123",
    dateOfIncorporation: "2019-03-15",
    jurisdictionOfIncorporation: "Lagos, Nigeria",
    companyType: "Private Limited Company",
    primaryAddress: "87 Ajose Adeogun St, Victoria Island, Lagos, Nigeria",
    website: "https://zenithbankcom",
    primaryContact: {
      contactId: "person_001",
      fullName: "Adaora Umeoji",
      email: "test@test.demo",
      phone: "+111-555-0100",
      dateOfBirth: "1985-07-22",
      nationality: "Nigerian",
      residentialAddress: "87 Ajose Adeogun St, Victoria Island, Lagos, Nigeria",
  ...
  {
    entityId: "ent_002",
    companyName: "Pinnacle Stone Investments",
    legalName: "Pinnacle Stone Investments LLC",
    ...
    website: "https://pinnacleinvestments.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_003",
    companyName: "Ironclad Asset Partners",
    legalName: "Ironclad Asset Partners LLC",
    ...
    website: "https://ironcladpartners.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_004",
    companyName: "Bluehaven Wealth Advisors",
    legalName: "Bluehaven Wealth Advisors LLC",
    ...
    website: "https://bluehavenwealth.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_006",
    companyName: "Everstead Capital Group",
    legalName: "Everstead Capital Group LLC",
    ...
    website: "https://eversteadcapital.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_007",
    companyName: "Summit Ridge Finance",
    legalName: "Summit Ridge Finance LLC",
    registrationNumber: "ETAFX-LTD-00777",
    dateOfIncorporation: "2018-06-20",
    jurisdictionOfIncorporation: "Delaware, United States",
    companyType: "Private Limited Company",
    primaryAddress: "1006 Main Street, Boston, MA, USA",
    website: "https://summitridgefinance.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_008",
    companyName: "Crescent Bay Capital",
    legalName: "Crescent Bay Capital LLC",
    registrationNumber: "THETA-ITG-00999",
    dateOfIncorporation: "2019-09-09",
    jurisdictionOfIncorporation: "Delaware, United States",
    companyType: "Public Limited Company",
    primaryAddress: "1007 Main Street, Atlanta, GA, USA",
    website: "https://crescentbaycapital.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_009",
    companyName: "Silvercrest Financial Solutions",
    legalName: "Silvercrest Financial Solutions LLC",
    registrationNumber: "IOTA-GRC-01212",
    dateOfIncorporation: "2021-07-14",
    jurisdictionOfIncorporation: "Delaware, United States",
    companyType: "Corporation",
    primaryAddress: "1008 Main Street, Seattle, WA, USA",
    website: "https://silvercrestfinancial.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_010",
    companyName: "Aureus Financial Group",
    legalName: "Aureus Financial Group LLC",
    ...
    website: "https://aureusfinancial.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_011",
    companyName: "Stratus Equity Management",
    legalName: "Stratus Equity Management LLC",
    ...
    website: "https://stratusequity.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_012",
    companyName: "Orion Gate Holdings",
    legalName: "Orion Gate Holdings LLC",
    ...
    website: "https://oriongate.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_013",
    companyName: "Lighthouse Financial Services",
    legalName: "Lighthouse Financial Services LLC",
    registrationNumber: "NUGEN-DB-00223",
    dateOfIncorporation: "2023-03-30",
    jurisdictionOfIncorporation: "Delaware, United States",
    companyType: "Corporation",
    primaryAddress: "10012 Main Street, Houston, TX, USA",
    website: "https://lighthousefinancial.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_015",
    companyName: "Elmbridge Global Advisors",
    legalName: "Elmbridge Global Advisors LLC",
    registrationNumber: "OMICRON-API-00445",
    dateOfIncorporation: "2022-08-22",
    jurisdictionOfIncorporation: "Delaware, United States",
    companyType: "Private Limited Company",
    primaryAddress: "10014 Main Street, Detroit, MI, USA",
    website: "https://elmbridgeadvisors.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_017",
    companyName: "ClearPoint Capital Markets",
    legalName: "ClearPoint Capital Markets LLC",
    registrationNumber: "RHO-REG-SA-00789",
    dateOfIncorporation: "2021-03-15",
    jurisdictionOfIncorporation: "Delaware, United States",
    companyType: "Société Anonyme (S.A.)",
    primaryAddress: "10016 Main Street, Minneapolis, MN, USA",
    website: "https://clearpointcapital.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_019",
    companyName: "Keystone Financial Innovations",
    legalName: "Keystone Financial Innovations LLC",
    registrationNumber: "TAU-DFP-INC-00901",
    dateOfIncorporation: "2022-12-01",
    jurisdictionOfIncorporation: "Delaware, United States",
    companyType: "Incorporated Company",
    primaryAddress: "10018 Main Street, San Diego, CA, USA",
    website: "https://keystoneinnovations.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_020",
    companyName: "Northstar Treasury Partners",
    legalName: "Northstar Treasury Partners LLC",
    ...
    website: "https://northstarpartners.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_021",
    companyName: "Harborline Wealth Management",
    legalName: "Harborline Wealth Management LLC",
    ...
    website: "https://harborlinewealth.example.com",
    primaryContact: {
  ...
  {
    entityId: "ent_022",
    companyName: "Redwood Bridge Capital",
    legalName: "Redwood Bridge Capital LLC",
    ...
    website: "https://redwoodbridge.example.com",
    primaryContact: {
